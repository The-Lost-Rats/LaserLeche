...
{
    public const string Button = "button select";
    public const string LecheExplodes = "Leche explode";
    public const string LecheHurt = "leche hurt";
    public const string Jump = "leche jump";
...
{
    public const string GameMusic = "cow_game";
    public const string IntroMusic = "cow_lullaby";
}
